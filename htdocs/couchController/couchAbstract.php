...
<SERIAL LASTUPDT="<?=date("Ymd hms")?>"> 
 <CONTROLINFO> 
    ...
    <ARTICLES>
      <?if ($article['timeLine']['previous']['pid'] != ""){?>
        <PREVIOUS PID="<?=$article['timeLine']['previous']['pid']?>"><![CDATA[<?=$article['timeLine']['previous']['title']?>]]> </PREVIOUS>
      <?}?>

      <?if ($article['timeLine']['next']['pid'] != ""){?>
        <NEXT PID="<?=$article['timeLine']['next']['pid']?>"><![CDATA[<?=$article['timeLine']['next']['title']?>]]></NEXT>
      <?}?>      
    </ARTICLES>   
 </CONTROLINFO>
 <TITLEGROUP>
